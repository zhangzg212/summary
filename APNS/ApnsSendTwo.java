...
public class ApnsSendTwo
{
    public static void main(String[] args) throws Exception
    {
		...
		JSONObject json = new JSONObject();
			json.put("type",blackAwake.getType());// type 1 视频 2语音
			json.put( "fromUsercode", "1002" );
			json.put( "fromUsername", "lily" );
			json.put( "toUsercode", "1008" );
			json.put( "toUsername", "tom" );
